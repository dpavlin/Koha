...
INSERT INTO `marc_tag_structure` (`tagfield`, `liblibrarian`, `libopac`, `repeatable`, `mandatory`, `authorised_value`, `frameworkcode`) VALUES
		('000','ETYKIETA REKORDU','LEADER',0,1,'',''),
		('001','NUMER KONTROLNY REKORDU','CONTROL NUMBER',0,0,'',''),
		('003','IDENTYFIKATOR NUMERU KONTROLNEGO REKORDU','CONTROL NUMBER IDENTIFIER',0,0,'',''),
		('005','DATA OSTATNIEJ MODYFIKACJI REKORDU','DATE AND TIME OF LATEST TRANSACTION',0,0,'',''),
		('006','DANE KONTROLNE - DODATKOWA CHARAKTERYSTYKA DOKUMENTU','FIXED-LENGTH DATA ELEMENTS--ADDITIONAL MATERIAL CHARACTERISTICS--GENERAL INFORMATION',1,0,'',''),
		('007','DANE KONTROLNE - FORMA FIZYCZNA DOKUMENTU','PHYSICAL DESCRIPTION FIXED FIELD--GENERAL INFORMATION',1,0,'',''),
		('008','DANE KONTROLNE','FIXED-LENGTH DATA ELEMENTS--GENERAL INFORMATION',0,1,'',''),
		...
		('015','NUMER BIBLIOGRAFII NARODOWEJ','NATIONAL BIBLIOGRAPHY NUMBER',1,0,'',''),
		...
		('020','ISBN','INTERNATIONAL STANDARD BOOK NUMBER',1,0,NULL,''),
		('022','ISSN','INTERNATIONAL STANDARD SERIAL NUMBER',1,0,NULL,''),
		('023','STANDARD FILM NUMBER (VM) [DELETED]','STANDARD FILM NUMBER (VM) [DELETED]',1,0,NULL,''),
		('024','INNY NUMER ZNORMALIZOWANY','OTHER STANDARD IDENTIFIER',1,0,NULL,''),
		('025','OVERSEAS ACQUISITION NUMBER','OVERSEAS ACQUISITION NUMBER',1,0,'',''),
		('026','FINGERPRINT','FINGERPRINT IDENTIFIER',1,0,'',''),
		('027','STANDARD TECHNICAL REPORT NUMBER','STANDARD TECHNICAL REPORT NUMBER',1,0,'',''),
		('028','NUMER WYDAWNICZY','PUBLISHER NUMBER',1,0,NULL,''),
		...
		('033','DATA/CZAS ZDARZENIA','DATE/TIME AND PLACE OF AN EVENT',1,0,'',''),
		('034','DANE MATEMATYCZNE ZAKODOWANE','CODED CARTOGRAPHIC MATHEMATICAL DATA',1,0,'',''),
		('035','NUMER SYSTEMOWY','SYSTEM CONTROL NUMBER',1,0,NULL,''),
		('036','ORIGINAL STUDY NUMBER FOR COMPUTER DATA FILES','ORIGINAL STUDY NUMBER FOR COMPUTER DATA FILES',0,0,'',''),
		('037','PUBLICATION, DISTRIBUTION DETAILS--SOURCE OF ACQUISITION','SOURCE OF ACQUISITION',1,0,NULL,''),
		...
		('040','ŹRÓDŁO KATALOGOWANIA','CATALOGING SOURCE',0,0,NULL,''),
		('041','KOD JĘZYKA','LANGUAGE CODE',1,0,'',''),
		('042','AUTHENTICATION CODE','AUTHENTICATION CODE',0,0,'',''),
		('043','GEOGRAPHIC AREA CODE','GEOGRAPHIC AREA CODE',0,0,NULL,''),
		('044','KOD KRAJU WYDAWCY/PRODUCENTA','COUNTRY OF PUBLISHING/PRODUCING ENTITY CODE',0,0,'',''),
		('045','TIME PERIOD OF CONTENT','TIME PERIOD OF CONTENT',0,0,'',''),
		('046','SPECIAL CODED DATES','SPECIAL CODED DATES',1,0,'',''),
		('047','KOD FORMY KOMPOZYCJI MUZYCZNEJ','FORM OF MUSICAL COMPOSITION CODE',1,0,'',''),
		('048','KOD OBSADY UTWORU MUZYCZNEGO','NUMBER OF MUSICAL INSTRUMENTS OR VOICES CODE',1,0,'',''),
		...
		('080','UNIWERSALNA KLASYFIKACJA DZIESIĘTNA','UNIVERSAL DECIMAL CLASSIFICATION NUMBER',1,0,NULL,''),
		('082','DEWEY DECIMAL CLASSIFICATION NUMBER','DEWEY DECIMAL CLASSIFICATION NUMBER',1,0,NULL,''),
		('084','NUMER INNEJ KLASYFIKACJI','OTHER CLASSIFICATION NUMBER',1,0,NULL,''),
		...
		('090','POLE LOKALNE - NUMER BIBLIOGRAFII REGIONALNEJ','LOCALLY ASSIGNED LC-TYPE CALL NUMBER (OCLC); LOCAL CALL NUMBER (OCLC)',1,0,'',''),
		...
		('100','HASŁO GŁÓWNE - NAZWA OSOBOWA','MAIN ENTRY--PERSONAL NAME',0,0,NULL,''),
		('110','HASŁO GŁÓWNE - NAZWA CIAŁA ZBIOROWEGO','MAIN ENTRY--CORPORATE NAME',0,0,NULL,''),
		('111','HASŁO GŁÓWNE - NAZWA IMPREZY','MAIN ENTRY--MEETING NAME',0,0,NULL,''),
		('130','HASŁO GŁÓWNE - TYTUŁ UJEDNOLICONY','MAIN ENTRY--UNIFORM TITLE',0,0,NULL,''),
		('210','SKRÓT TYTUŁU','ABBREVIATED TITLE',1,0,NULL,''),
		...
		('222','TYTUŁ KLUCZOWY','KEY TITLE',1,0,NULL,''),
		('240','TYTUŁ UJEDNOLICONY','UNIFORM TITLE',0,0,'Unititle',''),
		...
		('245','STREFA TYTUŁU I OZNACZENIA ODPOWIEDZIALNOŚCI','TITLE STATEMENT',0,1,'',''),
		('246','WARIANT TYTUŁU','VARYING FORM OF TITLE',1,0,NULL,''),
		('247','TYTUŁ POPRZEDNI','FORMER TITLE',1,0,NULL,''),
		('250','STREFA WYDANIA','EDITION STATEMENT',0,0,NULL,''),
		('254','STREFA POSTACI ZAPISU MUZYCZNEGO','MUSICAL PRESENTATION STATEMENT',0,0,NULL,''),
		('255','STREFA DANYCH MATEMATYCZNYCH','CARTOGRAPHIC MATHEMATICAL DATA',1,0,NULL,''),
		('256','CECHY PLIKU','COMPUTER FILE CHARACTERISTICS',0,0,NULL,''),
		...
		('260','STREFA ADRESU WYDAWNICZEGO','PUBLICATION, DISTRIBUTION, ETC. (IMPRINT)',1,0,NULL,''),
		...
		('270','PUBLICATION, DISTRIBUTION DETAILS--ADDRESS','ADDRESS',1,0,NULL,''),
		('300','STREFA OPISU FIZYCZNEGO','PHYSICAL DESCRIPTION',1,1,NULL,''),
		...
		('306','CZAS NAGRANIA','PLAYING TIME',0,0,NULL,''),
		('307','UWAGA DOTYCZĄCA CZASU I WARUNKÓW DOSTĘPU','HOURS, ETC.',1,0,NULL,''),
		('308','PHYSICAL DESCRIPTION FOR FILMS (ARCHIVAL) (VM) [OBSOLETE]','PHYSICAL DESCRIPTION FOR FILMS (ARCHIVAL) (VM) [OBSOLETE]',1,0,NULL,''),
		('310','BIEŻĄCA CZĘSTOTLIWOŚĆ','CURRENT PUBLICATION FREQUENCY',0,0,NULL,''),
		('315','FREQUENCY (CF MP) [OBSOLETE]','FREQUENCY (CF MP) [OBSOLETE]',0,0,NULL,''),
		('321','POPRZEDNIA CZĘSTOTLIWOŚĆ','FORMER PUBLICATION FREQUENCY',1,0,NULL,''),
		('340','MATERIAŁ/NOŚNIK','PHYSICAL MEDIUM',1,0,NULL,''),
		...
		('351','ORGANIZACJA I UKŁAD MATERIAŁU','ORGANIZATION AND ARRANGEMENT OF MATERIALS',1,0,NULL,''),
		...
		('362','STREFA NUMERACJI','DATES OF PUBLICATION AND/OR SEQUENTIAL DESIGNATION',1,0,NULL,''),
		('365','PUBLICATION, DISTRIBUTION DETAILS--TRADE PRICE','TRADE PRICE',1,0,NULL,''),
		('366','PUBLICATION, DISTRIBUTION DETAILS--TRADE AVAILABILITY INFORMATION','TRADE AVAILABILITY INFORMATION',1,0,NULL,''),
		...
		('440','STREFA SERII I DOKUMENTU WIELOCZĘŚCIOWEGO - FORMA DO WYSZUKIWANIA','SERIES STATEMENT/ADDED ENTRY--TITLE',1,0,NULL,''),
		('490','STREFA SERII I DOKUMENTU WIELOCZĘŚCIOWEGO - FORMA NIE DO WYSZUKIWANIA','SERIES STATEMENT',1,0,'',''),
		('500','UWAGI OGÓLNE','GENERAL NOTE',1,0,NULL,''),
		('501','UWAGA DOTYCZĄCA PRAC WSPÓŁWYDANYCH','WITH NOTE',1,0,NULL,''),
		('502','UWAGA DOTYCZĄCA DYSERTACJI','DISSERTATION NOTE',1,0,NULL,''),
		('503','BIBLIOGRAPHIC HISTORY NOTE (BK CF MU) [OBSOLETE]','BIBLIOGRAPHIC HISTORY NOTE (BK CF MU) [OBSOLETE]',1,0,NULL,''),
		('504','UWAGA DOTYCZĄCA BIBLIOGRAFII','BIBLIOGRAPHY, ETC. NOTE',1,0,NULL,''),
		('505','SFORMALIZOWANA UWAGA DOTYCZĄCA ZAWARTOŚCI','FORMATTED CONTENTS NOTE',1,0,NULL,''),
		('506','UWAGA DOTYCZĄCA OGRANICZEŃ W ROZPOWSZECHNIANIU','RESTRICTIONS ON ACCESS NOTE',1,0,NULL,''),
		('507','UWAGA DOTYCZĄCA SKALI DOKUMENTÓW GRAFICZNYCH','SCALE NOTE FOR GRAPHIC MATERIAL',0,0,NULL,''),
		('508','UWAGA DOTYCZĄCA OSÓB ZWIĄZANYCH Z DZIEŁEM','CREATION/PRODUCTION CREDITS NOTE',1,0,NULL,''),
		('509','INFORMAL NOTES (RLIN)','INFORMAL NOTES (RLIN)',0,0,NULL,''),
		('510','UWAGA DOTYCZĄCA CYTATY BIBLIOGRAFICZNEJ','CITATION/REFERENCES NOTE',1,0,NULL,''),
		('511','UWAGA DOTYCZĄCA UCZESTNIKA LUB WYKONAWCY','PARTICIPANT OR PERFORMER NOTE',1,0,NULL,''),
		...
		('515','UWAGA DOTYCZĄCA OSOBLIWOŚCI NUMEROWANIA','NUMBERING PECULIARITIES NOTE',1,0,NULL,''),
		('516','UWAGA DOTYCZĄCA TYPU PLIKU','TYPE OF COMPUTER FILE OR DATA NOTE',1,0,NULL,''),
		('517','CATEGORIES OF FILMS NOTE (ARCHIVAL) (VM) [OBSOLETE]','CATEGORIES OF FILMS NOTE (ARCHIVAL) (VM) [OBSOLETE]',0,0,NULL,''),
		('518','UWAGA DOTYCZĄCA DATY/CZASU I MIEJSCA ZDARZENIA','DATE/TIME AND PLACE OF AN EVENT NOTE',1,0,NULL,''),
		('520','UWAGA DOTYCZĄCA TREŚCI DOKUMENTU','SUMMARY, ETC.',1,0,NULL,''),
		('521','UWAGA DOTYCZĄCA PRZEZNACZENIA CZYTELNICZEGO','TARGET AUDIENCE NOTE',1,0,NULL,''),
		('522','GEOGRAPHIC DETAILS/GEOGRAPHIC COVERAGE NOTE','GEOGRAPHIC COVERAGE NOTE',1,0,NULL,''),
		...
		('525','UWAGA DOTYCZĄCA DODATKU','SUPPLEMENT NOTE',0,0,NULL,''),
		...
		('530','UWAGA DOTYCZĄCA INNEJ DOSTĘPNEJ POSTACI FIZYCZNEJ','ADDITIONAL PHYSICAL FORM AVAILABLE NOTE',1,0,NULL,''),
		('533','UWAGA DOTYCZĄCA REPRODUKCJI','REPRODUCTION NOTE',1,0,NULL,''),
		('534','UWAGA DOTYCZĄCA PODSTAWY REPRODUKCJI (WERSJI ORYGINALNEJ)','ORIGINAL VERSION NOTE',1,0,NULL,''),
		('535','LOCATION OF ORIGINALS/DUPLICATES NOTE','LOCATION OF ORIGINALS/DUPLICATES NOTE',1,0,NULL,''),
		('536','UWAGA DOTYCZĄCA ŹRÓDEŁ FINANSOWANIA DZIEŁA','FUNDING INFORMATION NOTE',1,0,NULL,''),
		('537','SOURCE OF DATA NOTE (CF) [OBSOLETE]','SOURCE OF DATA NOTE (CF) [OBSOLETE]',0,0,NULL,''),
		('538','WYMAGANIA TECHNICZNE','SYSTEM DETAILS NOTE',1,0,NULL,''),
		('540','UWAGA DOTYCZĄCA PRAWA AUTORSKIEGO','TERMS GOVERNING USE AND REPRODUCTION NOTE',1,0,NULL,''),
		...
		('555','UWAGA DOTYCZĄCA INDEKSU WIELOLETNIEGO','CUMULATIVE INDEX/FINDING AIDS NOTE',1,0,NULL,''),
		('556','UWAGA DOTYCZĄCA DOKUMENTACJI','INFORMATION ABOUT DOCUMENTATION NOTE',1,0,NULL,''),
		('561','UWAGA O PROWENIENCJI','OWNERSHIP AND CUSTODIAL HISTORY',1,0,NULL,''),
		('562','COPY AND VERSION IDENTIFICATION NOTE','COPY AND VERSION IDENTIFICATION NOTE',1,0,NULL,''),
		('563','UWAGA O OPRAWIE','BINDING INFORMATION',1,0,NULL,''),
		...
		('580','UWAGA O NIETYPOWYCH ZWIĄZKACH BIBLIOGRAFICZNYCH','LINKING ENTRY COMPLEXITY NOTE',1,0,NULL,''),
		('581','UWAGA DOTYCZĄCA PUBLIKACJI O OPISYWANYM DOKUMENCIE','PUBLICATIONS ABOUT DESCRIBED MATERIALS NOTE',1,0,NULL,''),
		('582','RELATED COMPUTER FILES NOTE (CF) [OBSOLETE]','RELATED COMPUTER FILES NOTE (CF) [OBSOLETE]',1,0,NULL,''),
		('583','UWAGA DOTYCZĄCA CZYNNOŚCI','ACTION NOTE',1,0,NULL,''),
		('584','ACCUMULATION AND FREQUENCY OF USE NOTE','ACCUMULATION AND FREQUENCY OF USE NOTE',1,0,NULL,''),
		('585','UWAGA DOTYCZĄCA WYSTAW','EXHIBITIONS NOTE',1,0,NULL,''),
		('586','UWAGA DOTYCZĄCA NAGRODY','AWARDS NOTE',1,0,NULL,''),
		('590','POLE LOKALNE - UWAGA','LOCAL NOTE (RLIN)',1,0,NULL,''),
		('600','HASŁO PRZEDMIOTOWE W FORMIE NAZWY OSOBOWEJ','SUBJECT ADDED ENTRY--PERSONAL NAME',1,0,NULL,''),
		('610','HASŁO PRZEDMIOTOWE W FORMIE NAZWY CIAŁA ZBIOROWEGO','SUBJECT ADDED ENTRY--CORPORATE NAME',1,0,NULL,''),
		('611','HASŁO PRZEDMIOTOWE W FORMIE NAZWY IMPREZY','SUBJECT ADDED ENTRY--MEETING NAME',1,0,NULL,''),
		('630','HASŁO PRZEDMIOTOWE W FORMIE TYTUŁU UJEDNOLICONEGO','SUBJECT ADDED ENTRY--UNIFORM TITLE',1,0,NULL,''),
		('648','SUBJECT--CHRONOLOGICAL TERM','SUBJECT ADDED ENTRY--CHRONOLOGICAL TERM',1,0,NULL,''),
		('650','HASŁO PRZEDMIOTOWE W FORMIE NAZWY OGÓLNEJ LUB JEDNOSTKOWEJ','SUBJECT ADDED ENTRY--TOPICAL TERM',1,0,NULL,''),
		('651','HASŁO PRZEDMIOTOWE W FORMIE NAZWY GEOGRAFICZNEJ','SUBJECT ADDED ENTRY--GEOGRAPHIC NAME',1,0,NULL,''),
		...
		('653','TERMIN INDEKSOWY - FORMA NIEKONTROLOWANA','INDEX TERM--UNCONTROLLED',1,0,NULL,''),
		('654','SUBJECT ADDED ENTRY--FACETED TOPICAL TERM','SUBJECT ADDED ENTRY--FACETED TOPICAL TERM',1,0,NULL,''),
		('655','TERMIN INDEKSOWY - OKREŚLENIE RODZAJU/FORMY DOKUMENTU','INDEX TERM--GENRE/FORM',1,0,NULL,''),
		('656','SUBJECT--OCCUPATION','INDEX TERM--OCCUPATION',1,0,NULL,''),
		('657','SUBJECT--FUNCTION','INDEX TERM--FUNCTION',1,0,NULL,''),
		('658','SUBJECT--CURRICULUM OBJECTIVE','INDEX TERM--CURRICULUM OBJECTIVE',1,0,NULL,''),
		('662','SUBJECT ADDED ENTRY--HIERARCHICAL PLACE NAME','SUBJECT ADDED ENTRY--HIERARCHICAL PLACE NAME',1,0,NULL,''),
		('690','LOCAL SUBJECT--TOPICAL TERM (OCLC, RLIN)','LOCAL SUBJECT ADDED ENTRY--TOPICAL TERM (OCLC, RLIN)',1,0,'',''),
		...
		('699','DZIAŁ BIBLIOGRAFII - ADRES SKRÓCONY OPISU (ODSYŁACZA)','LOCAL SUBJECT ADDED ENTRY--UNIFORM TITLE (RLIN)',1,0,'',''),
		('700','HASŁO DODATKOWE - NAZWA OSOBOWA','ADDED ENTRY--PERSONAL NAME',1,0,NULL,''),
		('705','ADDED ENTRY--PERSONAL NAME (PERFORMER) (MU) [OBSOLETE]','ADDED ENTRY--PERSONAL NAME (PERFORMER) (MU) [OBSOLETE]',1,0,NULL,''),
		('710','HASŁO DODATKOWE - NAZWA CIAŁA ZBIOROWEGO','ADDED ENTRY--CORPORATE NAME',1,0,NULL,''),
		('711','HASŁO DODATKOWE - NAZWA IMPREZY','ADDED ENTRY--MEETING NAME',1,0,NULL,''),
		('715','ADDED ENTRY--CORPORATE NAME (PERFORMER) (MU) [OBSOLETE]','ADDED ENTRY--CORPORATE NAME (PERFORMER) (MU) [OBSOLETE]',1,0,NULL,''),
		('720','HASŁO DODATKOWE - NAZWA W POSTACI NIEKONTROLOWANEJ','ADDED ENTRY--UNCONTROLLED NAME',1,0,NULL,''),
		('730','HASŁO DODATKOWE - TYTUŁ UJEDNOLICONY/TYTUŁ FORMALNY','ADDED ENTRY--UNIFORM TITLE',1,0,NULL,''),
		('740','HASŁO DODATKOWE - TYTUŁ DOKUMENTU ZWIĄZANEGO/TYTUŁ PRACY WSPÓŁWYDANEJ','ADDED ENTRY--UNCONTROLLED RELATED/ANALYTICAL TITLE',1,0,NULL,''),
		('752','HASŁO DODATKOWE - HIERARCHICZNE NAZWY MIEJSCA','ADDED ENTRY--HIERARCHICAL PLACE NAME',1,0,NULL,''),
		...
		('760','TYTUŁ SERII GŁÓWNEJ','MAIN SERIES ENTRY',1,0,NULL,''),
		('762','TYTUŁ PODSERII','SUBSERIES ENTRY',1,0,NULL,''),
		('765','TYTUŁ ORYGINAŁU','ORIGINAL LANGUAGE ENTRY',1,0,NULL,''),
		('767','TYTUŁ TŁUMACZENIA','TRANSLATION ENTRY',1,0,NULL,''),
		('770','TYTUŁ SAMOISTNEGO DODATKU CIĄGŁEGO/ZESZYTU SPECJALNEGO','SUPPLEMENT/SPECIAL ISSUE ENTRY',1,0,NULL,''),
		('772','TYTUŁ DOKUMENTU NADRZĘDNEGO DLA DODATKU','SUPPLEMENT PARENT ENTRY',1,0,NULL,''),
		('773','TYTUŁ DOKUMENTU MACIERZYSTEGO','HOST ITEM ENTRY',1,0,NULL,''),
		('774','CONSTITUENT UNIT ENTRY','CONSTITUENT UNIT ENTRY',1,0,NULL,''),
		('775','ODMIENNE WYDANIE','OTHER EDITION ENTRY',1,0,NULL,''),
		('776','ODMIENNA POSTAĆ FIZYCZNA','ADDITIONAL PHYSICAL FORM ENTRY',1,0,NULL,''),
		('777','TYTUŁ DOKUMENTU WSPÓŁWYDANEGO','ISSUED WITH ENTRY',1,0,NULL,''),
		('780','TYTUŁ POPRZEDNI','PRECEDING ENTRY',1,0,NULL,''),
		('785','TYTUŁ NASTĘPNY','SUCCEEDING ENTRY',1,0,NULL,''),
		('786','DATA SOURCE ENTRY','DATA SOURCE ENTRY',1,0,NULL,''),
		('787','INNY RODZAJ POWIĄZAŃ','NONSPECIFIC RELATIONSHIP ENTRY',1,0,NULL,''),
		...
		('800','HASŁO DODATKOWE OPISU DOKUMENTU WIELOCZĘŚCIOWEGO - NAZWA OSOBOWA','SERIES ADDED ENTRY--PERSONAL NAME',1,0,NULL,''),
		('810','HASŁO DODATKOWE OPISU DOKUMENTU WIELOCZĘŚCIOWEGO - NAZWA CIAŁA ZBIOROWEGO','SERIES ADDED ENTRY--CORPORATE NAME',1,0,NULL,''),
		('811','HASŁO DODATKOWE OPISU DOKUMENTU WIELOCZĘŚCIOWEGO - NAZWA IMPREZY','SERIES ADDED ENTRY--MEETING NAME',1,0,NULL,''),
		('830','HASŁO DODATKOWE SERII LUB DOKUMENTU WIELOCZĘŚCIOWEGO - TYTUŁ UJEDNOLICONY','SERIES ADDED ENTRY--UNIFORM TITLE',1,0,NULL,''),
		...
		('850','INSTYTUCJA POSIADAJĄCA DOKUMENT','HOLDING INSTITUTION',1,0,NULL,''),
		...
		('856','LOKALIZACJA I DOSTĘP DO ELEKTRONICZNYCH DOKUMENTÓW ZDALNYCH','ELECTRONIC LOCATION AND ACCESS',1,0,NULL,''),
		...
		('866','NIESFORMALIZOWANY OPIS ZASOBU -JEDNOSTKA OPISU BIBLIOGRAFICZNEGO','TEXTUAL HOLDINGS--BASIC BIBLIOGRAPHIC UNIT',1,0,NULL,''),
		('867','NIESFORMALIZOWANY OPIS ZASOBU - DOKUMENT TOWARZYSZĄCY','TEXTUAL HOLDINGS--SUPPLEMENTARY MATERIAL',1,0,NULL,''),
		('868','NIESFORMALIZOWANY OPIS ZASOBU - INDEKS','TEXTUAL HOLDINGS--INDEXES',1,0,NULL,''),
		...
		('900','POLE LOKALNE - ODSYŁACZ CAŁKOWITY - HASŁO OSOBOWE','EQUIVALENCE OR CROSS-REFERENCE-PERSONAL NAME [LOCAL, CANADA]',1,0,'',''),
